...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while num_rolls > 0:
        ...
        if outcome == 1:
            sow_sad = True
        num_rolls -= 1
    return sum if not sow_sad else 1
    # END PROBLEM 1
...
def final_strategy(score, opponent_score):
    ...
    Take no risks when victory is one roll ahead, otherwise use 'sus_strategy'
    ...
    if sus_update(0, score, opponent_score) >= GOAL:
        ...
        return sus_strategy(score, opponent_score, threshold=9)
    # END PROBLEM 12
